...
abstract class BaseTabFragment<VM : BaseViewModel, DB : ViewDataBinding> :
    ...
    override fun createObserver() {
        getRequestViewModel()?.run {
            ...
            getErrorLiveData().observeInFragment(this@BaseTabFragment, Observer {
                showErrorPage(it)
            })
        }
    }
    ...
    protected open fun createNavigatorAdapter(): CommonNavigatorAdapter? {
        return object : CommonNavigatorAdapter() {
            ...
            override fun getTitleView(context: Context, index: Int): IPagerTitleView {
                return getNavTitleView(context, index, mTabs)
            }
    ...
    protected open fun getNavTitleView(
        ...
        SkinPagerTitleView(context).init(index, tabs, getViewPager()).initBadgePager(context)

    protected open fun getNavIndicator(context: Context): IPagerIndicator =
        SkinLinePagerIndicator(context).init()
